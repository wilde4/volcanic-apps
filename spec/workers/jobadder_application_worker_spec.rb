...
describe JobadderApplicationWorker do
  ...
  context 'When testing the JobadderApplicationWorker' do
    ...
    #TODO find  way to stub ja_setting.add_single_attachment inside upload files

    it 'should pass perform sqs message, new candidate' do
      ...
      # expect {worker.perform(msg, msg)}.to output('test').to_stdout
